...
const Menu = () => {
  return (
      <div className='divporq'>
        ...
        <h2 className='descrip'>Desde LATE Chocolates hacemos todo con mucho amor y dedicacion al chocolate. Lo que una vez empezo como un hobby hoy se ha convertido en algo mucho mas que ello. La dedicacion de una familia a logrado posicionar a LATE como un referente en la experimentacion con sabores nunca antes imaginados, combinaciones nunca antes vistas, chocolates nuevos. Sumate a este aventura y forma parte de esta hermosa familia, no te arrepentiras.</h2>
